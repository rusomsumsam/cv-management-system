                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-slate-600 mt-1">
                                View detailed information about this reusable attribute.
                            </p>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                onClick={() => navigate(`/attributes/edit/${id}`)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <p className="text-lg font-semibold text-slate-900">{attribute.name || "N/A"}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-base text-slate-900">{attribute.category || "N/A"}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <div className="pt-1">{getTypeBadge(attribute.type)}</div>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-base text-slate-900">{formatDate(attribute.createdAt)}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-base text-slate-900">{formatDate(attribute.updatedAt)}</p>
                            </div>
                        </div>
                    </div>
                </div>

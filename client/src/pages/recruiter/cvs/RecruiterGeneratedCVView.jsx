...
const RecruiterGeneratedCVView = () => {
    const { id } = useParams();
        ...
        api
            ...
            .catch((requestError) => {
                ...
                setError(
                    ...
                    "Failed to load the rendered Published CV. Please try again."
                );
                console.error("Failed to load Recruiter generated CV:", requestError.message);
            })
            .finally(() => {
                if (!cancelled) {
                    setLoading(false);
        ...
        return (
            <div className="min-h-[320px] flex items-center justify-center">
                <div className="flex items-center gap-3 text-slate-600 dark:text-slate-400">
                    ...
                    <span className="text-sm font-medium">Loading Rendered CV...</span>
                </div>
            </div>
        );
    }
            ...
            <div className="space-y-6" role="alert">
                ...
                <div className="rounded-xl border border-red-200 bg-red-50 dark:border-red-900/50 dark:bg-red-900/20 p-6">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Rendered Published CV</h2>
        ...
        <div className="space-y-6">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Rendered Published CV</h1>
                        <p className="text-slate-600 dark:text-slate-400 mt-1">
                            Read-only generated CV for {candidateName} and {cv.position?.title || "this position"}.
                        </p>
                    </div>
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20 p-4 flex items-start gap-3">
                ...
                <div>
                    <p className="text-blue-800 dark:text-blue-300 text-sm font-medium">Read-only rendered view</p>
                    <p className="text-blue-700 dark:text-blue-400 text-sm mt-0.5">
                        This page dynamically renders the Candidate's current shared Profile Attribute values and Position-matched Profile Projects.
                    </p>
                </div>
            </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-lg p-8 md:p-12 space-y-8 print:shadow-none print:border-0 print:p-0 print:bg-white print:text-black">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 border-b-2 border-slate-100 dark:border-slate-800 pb-2">
                            ...
                            <h2 className="text-xl font-bold text-slate-900 dark:text-white">Position-Matched Candidate Projects</h2>
                        </div>
                        <div className="flex items-start gap-2 text-sm text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg">
                            ...
                            <p>
                                Projects are loaded dynamically from the Candidate Profile. Only Projects matching at least one Position Technology Tag are included, up to the Position's configured Project limit.
                            </p>
                        </div>
                        {profileProjects.length === 0 ? (
                            <div>
                                <p className="text-slate-500 dark:text-slate-400 italic">No Candidate Profile Projects match this Position's Technology Tags.</p>
                                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                    Only matching Projects within the Position's configured Project limit are included in this CV.
                                </p>
                            </div>
                        ) : (
                            <div className="space-y-4">
...
export default RecruiterGeneratedCVView;
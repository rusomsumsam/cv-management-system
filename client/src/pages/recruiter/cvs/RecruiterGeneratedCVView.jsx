// client/src/pages/recruiter/cvs/RecruiterGeneratedCVView.jsx
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20 p-4 flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-blue-700 dark:text-blue-400 text-sm mt-0.5">
                        This page dynamically renders the Candidate’s current shared Profile Attribute values and relational Profile Projects.
                    </p>
                </div>
            </div>
